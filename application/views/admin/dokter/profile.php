        ...
        <div class="card d-flex" style="align-items: center;">
            <div class="card-body" style="max-width: 540px;">
                <div class="filter-dokter">
                    <form action="<?= base_url('admin/dokter/filterdokter') ?>" method="get">
                        ...
                        <div class="form-group">
                            <button class="btn btn-danger btn-block">CARI</button> <?php if (!empty($filter)) : ?>
                            <a href="<?= base_url('admin/dokter/profil') ?>" class="btn btn-secondary">TUTUP</a>
                            <?php endif ?>
                        </div>
                    </form>
                </div>
                    ...
                    <nav aria-label="Page navigation example" class="text-center">
                        <ul class="pagination d-flex justify-content-center">
                            ...
                            <li class="page-item"><a class="page-link"
                                    href="<?= base_url('admin/dokter/profil/' . $i) ?>"
                                    class=<?= current_url() == base_url('admin/dokter/profil/' . $i) ? 'text-danger' : '' ?>><?= $i ?></a>
                            </li>
                            <?php endfor; ?>
                        </ul>
                    </nav>
